...
class hrrsd_pseudo_label(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'hrrsd_pseudo_label' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.HRRSD_PSEUDO_LABEL
        ...
        self._classes = ('__background__', 'airplane', 'ship', 'storagetank', 'baseball diamond',
        ...
        self.pseudo_label_score_thresh = cfg.TRAIN.PSEUDO_LABEL_THRESH
    ...
    def _load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            scores[ix] = score
            # if score < self.pseudo_label_score_thresh:
            #     continue
        ...
        boxes = boxes[scores >= self.pseudo_label_score_thresh]
        gt_classes = gt_classes[scores >= self.pseudo_label_score_thresh]
        ishards = ishards[scores >= self.pseudo_label_score_thresh]
        overlaps = overlaps[scores >= self.pseudo_label_score_thresh]
        seg_areas = seg_areas[scores >= self.pseudo_label_score_thresh]
