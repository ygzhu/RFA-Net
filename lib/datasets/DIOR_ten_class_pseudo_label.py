...
class DIOR_ten_class_pseudo_label(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'DIOR_ten_class_pseudo_label' + image_set)
        self._year = year
        self._image_set = image_set
        self._devkit_path = cfg_d.DIOR_ten_class_pseudo_label#self._get_default_path() if devkit_path is None \
