...
def parse_args():
    ...
    parser.add_argument('--lc', dest='lc',
                        ...
                        action='store_true')
    parser.add_argument('--mid', dest='mid',
                        help='whether use context vector for mid level',
                        action='store_true')
    ...
    parser.add_argument('--cag', dest='class_agnostic',
                        ...
                        action='store_true')
    parser.add_argument('--after_layer2', dest='after_layer2',
                        help='where to place the self-attention module, after_layer2 or after_layer3',
                        action='store_true')
...
def set_dataset_args(args, test=False):
    if not test:
        if args.dataset == "pascal_voc":
            ...
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '30']
        elif args.dataset == "nwpu_vhr":
            args.imdb_name = "nwpu_vhr_trainval"
            args.imdbval_name = "nwpu_vhr_test"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        elif args.dataset == "hrrsd":
            args.imdb_name = "hrrsd_trainval"
            args.imdbval_name = "hrrsd_test"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        elif args.dataset == "hrrsd_pseudo_label":
            args.imdb_name = "hrrsd_pseudo_label_trainval"
            args.imdbval_name = "hrrsd_pseudo_label_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        elif args.dataset == "DIOR_ten_class":
            args.imdb_name = "DIOR_ten_class_trainval"
            args.imdbval_name = "DIOR_ten_class_test"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        elif args.dataset == "DIOR_ten_class":
            args.imdb_name = "DIOR_ten_class_pseudo_label_trainval"
            args.imdbval_name = "DIOR_ten_class_pseudo_label_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        ...
        #                             '20']
            ...
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '30']
        elif args.dataset_t == "nwpu_vhr":
            args.imdb_name_target = "nwpu_vhr_trainval"
            args.imdbval_name_target = "nwpu_vhr_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '50']
        elif args.dataset_t == "hrrsd":
            args.imdb_name_target = "hrrsd_trainval"
            args.imdbval_name_target = "hrrsd_test"
            # args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32, 64]', 'ANCHOR_RATIOS', '[0.2,0.5,1,2,5]',
                                    'MAX_NUM_GT_BOXES', '50']
        elif args.dataset_t == "hrrsd_pseudo_label":
            args.imdb_name_target = "hrrsd_pseudo_label_trainval"
            args.imdbval_name_target = "hrrsd_pseudo_label_trainval"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '50']
            # args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32, 64]', 'ANCHOR_RATIOS', '[0.2,0.5,1,2,5]', 'MAX_NUM_GT_BOXES', '50']
        elif args.dataset_t == "DIOR_ten_class":
            args.imdb_name_target = "DIOR_ten_class_trainval"
            args.imdbval_name_target = "DIOR_ten_class_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '50']
        elif args.dataset_t == "DIOR_ten_class_pseudo_label":
            args.imdb_name_target = "DIOR_ten_class_pseudo_label_trainval"
            args.imdbval_name_target = "DIOR_ten_class_pseudo_label_trainval"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '50']
        ...
        elif args.dataset == "DIOR_ten_class_pseudo_label":
            args.imdb_name = "DIOR_ten_class_pseudo_label_trainval"
            args.imdbval_name = "DIOR_ten_class_pseudo_label_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
